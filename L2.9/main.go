...
func main() {
	var a string
	fmt.Println("введите корректную строку для распаковки")
	fmt.Scan(&a)
...
// GetUnpacking проводит распаковку строки и возвращает коректное значение или ошибку
// исходя из примеров в задании, ошибка возникает при встрече числа, а не цифры (две цифры подряд) или отсутсвия букв
// а также, если знак цифры в строке неэкранирован, а перед ним нет буквы или экранированной цифры
